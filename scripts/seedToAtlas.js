...
// Set your credentials via environment variable or replace this placeholder
const MONGODB_ATLAS_URI =
  process.env.MONGODB_URI ||
  "mongodb+srv://YOUR_USERNAME:YOUR_PASSWORD@YOUR_CLUSTER.mongodb.net/fashion-store?retryWrites=true&w=majority";
...
const products = [
  ...
  // === SẢN PHẨM KHÔNG SALE (để test filter "On Sale Only") ===
  {
    ...
    description: "Relaxed fit shorts made from a breathable cotton-linen blend.",
    ...
    category: "men",
    subcategory: "shorts",
    tags: ["shorts", "cotton", "linen", "summer"],
    isActive: true,
    isFeatured: false,
    isNewArrival: true,
    isOnSale: false,
    ...
    features: ["Cotton-linen blend", "Elastic waistband"],
  },
  {
    name: "Silk Scarf",
    slug: "silk-scarf",
    description: "A luxurious 100% silk scarf with a beautiful abstract print.",
    shortDescription: "Luxurious 100% silk scarf",
    brand: "Luxe Fashion",
    price: 79.99,
    compareAtPrice: null,
    stock: 40,
    sku: "SLK-SCF-012",
    sizes: [{ name: "One Size", stock: 40 }],
    colors: [{ name: "Multicolor", hexCode: "#FF6B6B", stock: 40 }],
    images: [
      {
    ...
    features: ["100% Mulberry Silk"],
  },
  // === SẢN PHẨM HẾT HÀNG (để test filter "In Stock Only") ===
  {
    name: "Velvet Evening Gown",
    slug: "velvet-evening-gown",
    description: "A stunning velvet evening gown with a plunging neckline.",
    shortDescription: "Stunning velvet evening gown",
    ...
    category: "women",
    subcategory: "dresses",
    tags: ["velvet", "evening gown", "formal"],
    isActive: true,
    isFeatured: true,
    isNewArrival: false,
    isOnSale: true,
    ...
    features: ["Premium velvet", "Floor-length"],
  },
  {
    name: "Vintage Leather Watch",
    slug: "vintage-leather-watch",
    description: "A classic vintage-style watch with genuine leather strap.",
    shortDescription: "Classic vintage watch",
    ...
    colors: [
      { name: "Brown", hexCode: "#8B4513", stock: 0 },
      { name: "Black", hexCode: "#000000", stock: 0 },
    ],
    images: [
      {
    ...
    features: ["Japanese quartz movement", "Genuine leather strap"],
  },
  {
    name: "Kids Striped Polo Shirt",
    slug: "kids-striped-polo-shirt",
    description: "A colorful striped polo shirt for kids.",
    shortDescription: "Soft cotton polo for kids",
    brand: "Urban Style",
    price: 29.99,
    compareAtPrice: null,
    stock: 0,
    ...
    careInstructions: ["Machine wash cold"],
    features: ["100% Cotton piqué", "Classic collar"],
  },
];
